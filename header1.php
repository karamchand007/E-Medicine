...
<div class="row" style="background:#F00">
	<div class="col-md-4 col-xs-12">
    	<p style="color:#fff; padding-top:5px;">
        	<a href="admin_panel.php"><img src="img/medicine logo.png" class="img-responsive"></a>
        </p>
    </div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav c">
        ...
        <li>
          <a href="view_book.php"><span class="glyphicon glyphicon-eye-open"></span> View Book </a> </li>
